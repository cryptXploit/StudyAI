...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.prepia.app'),
  title: {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://www.prepia.app',
    siteName: 'Prepia AI',
    title: 'Prepia AI – #1 AI Study Operating System for Students',
    description: 'Transform textbooks & PDFs into flashcards, 3D organic molecules, AI podcasts & exam cheat sheets in seconds. Accurate RAG-powered study tool for students.',
    images: [
      {
        url: 'https://www.prepia.app/assets/og-cover.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://www.prepia.app/assets/og-cover.png'],
    creator: '@PrepiaAI'
  },
  alternates: {
    canonical: 'https://www.prepia.app'
  },
  robots: {
    index: true,
    follow: true,
