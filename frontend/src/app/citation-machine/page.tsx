...
// import { Quote, Lightbulb, Link as LinkIcon, BookOpen, Hash, Loader2, Copy, Check, History, Trash2, Sparkles, BookMarked } from 'lucide-react';
...
//         body: JSON.stringify({ input_text: inputText.trim(), style: selectedStyle })
//       });
...
export default function CitationMachinePage() { return null; }
